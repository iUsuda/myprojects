...
inline int ond::ReadTR73U(std::string file, std::vector<double>& v_time, std::vector<double>& v_ch1, std::vector<double>& v_ch2, std::vector<double>& v_ch3){
    ...
    while(getline(ifs, buf)){
        ...
        sscanf(buf.data(),"\"%d/%d/%d %d:%d'%d\",\"%*lf\",\"%lf\",\"%lf\",\"%lf\",\"%*lf\",\"%*lf\",\"%*lf\",\"%*lf\",\"%*lf\",", &y, &m, &d, &hh, &mm, &ss, &ch1, &ch2, &ch3);
...
inline int ond::ReadTR73U(std::string file, std::vector<double>& v_time, std::vector<double>& v_ch1, std::vector<double>& v_ch2, std::vector<double>& v_ch3, double start, double end){
    double time, ch1, ch2, ch3;
    int y, m, d, hh, mm, ss;
